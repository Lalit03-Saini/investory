                ...
                <div className="container-fluid welcome">
                    ...
                    <div className="row acmanage">
                        ...
                        <div className="col-12">
                            <div className="add_account"><Link to="add_property.html">Add Property</Link></div>
                            <ul className="nav nav-tabs" role="tablist">
                                ...
                                <li><Link id="tab-4" to="#pane-4" className=" " data-bs-toggle="tab" role="tab">SUBMITTED OFFERS (4)</Link></li>
                            ...
                            <div id="content" className="tab-content" role="tablist">
                                                    ...
                                                    <div className="col-md-6 col-xl-4 col-xxl-3">
                                                        <div className="slider_block">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p><Link to="client_view_property.html">View Property</Link></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-6 col-xl-4 col-xxl-3">
                                ...
                                <div id="pane-4" className="card tab-pane fade" role="tabpanel" aria-labelledby="tab-4">
                                    <div className="card-header" role="tab" id="heading-4">
                                        <Link data-bs-toggle="collapse" to="#collapse-4" aria-expanded="false" aria-controls="collapse-4">SUBMITTED OFFERS (4)</Link>
                                    </div>
...
export default Client_view_engagement;