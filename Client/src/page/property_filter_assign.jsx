        ...
        <>
            <div className="container-fluid hpadding">
                ...
                <div className="container-fluid welcome">
                    ...
                    <div className="row acmanage filterpage assigned_property">
                        <div className="col-12">
                            <div className="filtering_wrap">
                                <div className="add_account"><Link to="add_property.html" className="addbutton">Add Property</Link> <Link to="#" className="assignbutton" data-bs-toggle="modal" data-bs-target="#assignmodal">Assign</Link></div>
                                <div className="last_update">Last Updated 01/01/23</div>
                                <div className="property_select"><span id="selected">0</span> properties selected</div>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="bottom_button">
                                                        ...
                                                        <span className="vclient">
                                                            <label><input type="checkbox" className="checkbox" name="assign" data-target={1} /> <i />Assign Property</label>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="slider_block">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="bottom_button">
                                                        <span><Link to="property_filter_view.html">View Property</Link></span>
                                                        <span className="vclient">
                                                            <label><input type="checkbox" className="checkbox" name="assign" data-target={2} /> <i />Assign Property</label>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-xl-4 col-xxl-3 category-2 item" data-id={3}>
                                            <div className="slider_block">
                                                <div>
                                                    <i className="star"><img src="images/star_hover.svg" alt="" /></i>
                                                    <p><img src="images/thumbnail3.png" alt="" /></p>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="bottom_button">
                                                        <span><Link to="property_filter_view.html">View Property</Link></span>
                                                        <span className="vclient">
                                                            <label><input type="checkbox" className="checkbox" name="assign" data-target={3} /> <i />Assign Property</label>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-xl-4 col-xxl-3 category-2 item" data-id={4}>
                                            <div className="slider_block">
                                                <div>
                                                    <i className="star"><img src="images/star_hover.svg" alt="" /></i>
                                                    <p><img src="images/thumbnail3.png" alt="" /></p>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="bottom_button">
                                                        <span><Link to="property_filter_view.html">View Property</Link></span>
                                                        <span className="vclient">
                                                            <label><input type="checkbox" className="checkbox" name="assign" data-target={4} /> <i />Assign Property</label>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-xl-4 col-xxl-3 category-2 item" data-id={5}>
                                            <div className="slider_block">
                                                <div>
                                                    <i className="star"><img src="images/star_hover.svg" alt="" /></i>
                                                    <p><img src="images/thumbnail3.png" alt="" /></p>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="bottom_button">
                                                        <span><Link to="property_filter_view.html">View Property</Link></span>
                                                        <span className="vclient">
                                                            <label><input type="checkbox" className="checkbox" name="assign" data-target={5} /> <i />Assign Property</label>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-xl-4 col-xxl-3 category-2 item" data-id={6}>
                                            <div className="slider_block">
                                                <div>
                                                    <i className="star"><img src="images/star_hover.svg" alt="" /></i>
                                                    <p><img src="images/thumbnail3.png" alt="" /></p>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="bottom_button">
                                                        <span><Link to="property_filter_view.html">View Property</Link></span>
                                                        <span className="vclient">
                                                            <label><input type="checkbox" className="checkbox" name="assign" data-target={6} /> <i />Assign Property</label>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-xl-4 col-xxl-3 category-2 item" data-id={7}>
                                            <div className="slider_block">
                                                <div>
                                                    <i className="star"><img src="images/star_hover.svg" alt="" /></i>
                                                    <p><img src="images/thumbnail3.png" alt="" /></p>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="bottom_button">
                                                        <span><Link to="property_filter_view.html">View Property</Link></span>
                                                        <span className="vclient">
                                                            <label><input type="checkbox" className="checkbox" name="assign" data-target={7} /> <i />Assign Property</label>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-xl-4 col-xxl-3 category-2 item" data-id={8}>
                                            <div className="slider_block">
                                                <div>
                                                    <i className="star"><img src="images/star_hover.svg" alt="" /></i>
                                                    <p><img src="images/thumbnail3.png" alt="" /></p>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="bottom_button">
                                                        <span><Link to="property_filter_view.html">View Property</Link></span>
                                                        <span className="vclient">
                                                            <label><input type="checkbox" className="checkbox" name="assign" data-target={8} /> <i />Assign Property</label>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
...
export default Property_filter_assign;